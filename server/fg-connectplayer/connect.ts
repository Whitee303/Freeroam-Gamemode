...
const suggestions = [
	{ name: 'v', description: 'You can create your own vehicle!', params: [{ name: 'Vehicle Name' }], },
	{ name: 'wp', description: 'You can spawn a weapon', params: [{ name: 'Weapon Name' }], },
	{ name: 'dvc', description: 'You can destroy a vehicle' },
	{ name: 'vcol', description: 'If you want to change the color of your vehicle, you can try this!', params: [{ name: 'Color Number' }], },
	{ name: 'fix', description: "Is your vehicle damaged? Don't worry, type /fix" },
	{ name: 'rcol', description: 'Rainbow is beautiful...' },
...
class HandlePlayerConnect {
	...
	private static propagate(player: Player) {
